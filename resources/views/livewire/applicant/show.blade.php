                    ...
                    <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">                            
                     ...
                     <div class="items-center px-4">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <th class="border-2 px-3 py-3 text-sm text-center font-medium leading-4  text-gray-900 bg-gray-50">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex" style="cursor: pointer" wire:click="sortBy('created_at')">
                                        ...
                                        <th class="border-2 px-2 py-3 text-sm text-center font-medium leading-4  text-gray-900 bg-gray-50">
                                            <div class="flex items-center justify-betwee n">
                                                <div class="">
                                                   <p class="text-bold text-md"> #SN</p>  
                                                </div>
                                               
                                                <div class="flex" style="cursor: pointer" wire:click="sortBy('sn_number')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M8 7l4-4m0 0l4 4m-4-4v18" />
                                                    </svg>
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                        ...
                                        <th class="border-2 px-3 py-3 text-sm text-center font-medium leading-4  text-gray-900 bg-gray-50">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex" style="cursor: pointer" wire:click="sortBy('last_name')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M8 7l4-4m0 0l4 4m-4-4v18" />
                                                    </svg>
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                        ...
                                        <th class="border-2 px-3 py-3 text-sm text-center font-medium leading-4  text-gray-900 bg-gray-50">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex" style="cursor: pointer" wire:click="sortBy('class_name')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M8 7l4-4m0 0l4 4m-4-4v18" />
                                                    </svg>
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                        ...
                                        <th class="border-2 px-3 py-3 text-sm text-center font-medium leading-4  text-gray-900 bg-gray-50">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex" style="cursor: pointer" wire:click="sortBy('status')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M8 7l4-4m0 0l4 4m-4-4v18" />
                                                    </svg>
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            ...
                            <x-jet-dialog-modal wire:model="confirmingApplicantAdd">
                                ...
                                <x-slot name="footer">
                                    <x-jet-secondary-button wire:click="confirmClosesave" wire:loading.attr="disabled">
                                        {{ __('Close') }}
                                    </x-jet-secondary-button>
                            ...
                            <x-jet-dialog-modal wire:model="confirmingeditApplicant">
                                ...
                                <x-slot name="footer">
                                    <x-jet-secondary-button wire:click="confirmCloseupdate" wire:loading.attr="disabled" >
                                        {{ __('Close') }}
                                    </x-jet-secondary-button>
                        ...
                        <x-jet-dialog-modal wire:model="confirmingApplicantDeletion">
                            ...
                            <x-slot name="footer">
                                <x-jet-secondary-button wire:click="confirmClosedelete" wire:loading.attr="disabled">
                                    {{ __('Close') }}
                                </x-jet-secondary-button>
