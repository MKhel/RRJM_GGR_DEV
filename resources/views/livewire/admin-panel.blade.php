        ...
        <div class=" justify-items-between">
            <div class="bg-white px-3 py-4 w-full mb-4">
                ...
                <div class="mt-4 bg-white">
                    <label for="about" class="text-sm font-medium text-gray-700"> New Status </label>
                    <div class="mt-1">
                        <textarea id="about" wire:model="new_status" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" 
                    ...
                    <div class="flex justify-end">
                        <div class="flex ">
                        <button class="mt-4 success border-2 rounded-lg px-4 py-2" wire:click="saveNewStatus()" wire:loading.attr="disabled">
                            {{ __('Post') }}
                        </button>
                        </div>
                    </div>
            ...
            <div class="py-auto w-full">
                    ...
                    <div class="px-4 py-5 sm:px-6 mt-2 bg-white">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button class="mt-4 success border-2 rounded-lg px-4 py-2" wire:click="openRegistration()" wire:loading.attr="disabled">
                            ADD NEW USER
                            </button>
                        </div>
                        ...
                        <table class="border-2 w-full md:table-fixed mt-4">
                            ...
                            <tbody>
                                @forelse ($users as $post)
                                    <tr class="border-2 p-2">
                                        <td class="border-2 p-2">{{$post->id}}</td>
                                        <td class="border-2 p-2">{{$post->name}}</td>
                                        <td class="border-2 p-2">
                                            @if ($post->role_id == '1' ) <span >Admin</span>
                                            @elseif ($post->role_id == '2') <span >Recruitment</span>
                                            @elseif ($post->role_id == '3') <span >Processing</span>
                                  
                                            @endif  
                                        </td>
                                        <td class="border-2 p-2 text-center">{{$post->active}} Active</td>
                                        <td class="border-2 p-2 text-center">{{ $post->created_at->format('d M Y')}}</td>
                                        ...
                                        <td class="items-center border-2 p-2 text-center">
                                                ...
                                                <button type="button" wire:click="deleteConfirmation({{$post->id}})" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white-400" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                         ...
                         <x-slot name="content">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-jet-input wire:model="confirm_password" d="password_confirmation" class="block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="new-password" />
